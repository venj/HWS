...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-(10)-[label1(==labelHeight@999)]-[label2(==label1)]-[label3(==label1)]-[label4(==label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: ["labelHeight": 88], views: viewsDictionary))
